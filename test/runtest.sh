...
tests=("first_test.c" "string_parse_test.c string_parse2_test.c" "httpcommand_test.c" "http_response_test.c" )
class=("" "../src/http/http.c" "../src/http/httpcommand.c ../src/http/http.c" "../src/http/http_response.c" )
